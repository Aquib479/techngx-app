...
const Services: React.FC = () => {
  return (
    <div className="services w-[90%] m-auto">
      <div className="main font-extralight my-12">
        <div className="pb-14 space-y-2">
          <h1 className="text-center text-3xl font-medium">Services</h1>
        ...
        <div className="grid grid-cols-2 gap-8">
          {/* First Box */}
          <div className="px-40 py-10 first-gradient relative overflow-hidden cursor-pointer rounded-xl">
            <CardWithLines
              heading="IT"
...
We understand the significance of streamlining processes for optimal efficiency. Our team of seasoned professionals is dedicated to facilitating the ease of doing business, leveraging cutting-edge technologies and innovative strategies."
            />
            <div className="absolute -top-14 -left-10 w-44 h-44 rounded-full border-2 border-black/10"></div>
          </div>

          {/* Second Box */}
          <div className="px-40 py-10 second-gradient text-white relative overflow-hidden cursor-pointer rounded-xl">
            <CardWithLines
              heading="Consulting"
              strongHeading="Services"
            ...
            />
            <div className="absolute -top-14 -left-10 w-44 h-44 rounded-full border-2 border-white/20"></div>
          </div>
        </div>
      </div>
    </div>
